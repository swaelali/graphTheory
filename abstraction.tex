...
\begin{itemize}
	\item {\color{blue} Verify directly that there are exactly 125 labelled trees on five vertices.}
			\underline{Ans.} for $n = 5$ vertices, there exists $5^{5-2}=125$ labelled trees.
	\item {\color{blue} \begin{itemize}
		\item[(i)] Show that there are exactly $2^{n(n-1)/2}$ labelled simple graphs on $n$ vertices.\\
				{\color{black} \underline{proof 1:}\\
						For an $n$-vertices simple graph, we have $n \choose 2$ of all possible edges, any one of this edges may or may not be in the graph. That is, the total number of collections of edges is $2^{n \choose 2}$. As each graph on $n$-vertices is uniquely described by which edges are present in the graph, we get $2^{n(n-1)/2}$ different labelled graph.\\
				\underline{Proof 2:} by induction.
				}
	...
	\end{itemize}}
	\item {\color{blue} In the first proof of Cayley's theorem, find:
	\begin{itemize}
			\item[(i)] the labelled trees corresponding to the sequences (1,2,3,4) and (3,3,3,3).
			{\color{black}
			\begin{figure}[h!]
				\centering
				\begin{tikzpicture}[scale=.3,-,>=stealth',shorten >=1pt,auto,node distance=1cm, semithick]
						\tikzstyle{vert}=[draw, circle, inner sep=2pt]
						\node[vert, label=left:5] 		(5)   {};
						\node[vert, label=right:1] 		(1) [right of=5]  {};
						\node[vert, label=right:2] 		(2) [below of=1]  {};
						\node[vert, label=left:3] 		(3) [left of=2]  {};
						\node[vert, label=left:4] 		(4) [below of=3]  {};
						\node[vert, label=right:6] 		(6) [right of=4]  {};
					\path
						(5) edge (1)
						(1) edge (2)
						(2) edge (3)
				...
				\begin{tikzpicture}[scale=.3,-,>=stealth',shorten >=1pt,auto,node distance=1cm, semithick]
						\tikzstyle{vert}=[draw, circle, inner sep=2pt]
						\node[vert, label=left:5] 		(5)   {};
						\node[vert, label=left:4] 		(4) [below of=5]  {};
						\node[vert, label=left:2] 		(2) [below of=4]  {};
						\node[vert, label=above:3] 		(3) [right of=4]  {};
						\node[vert, label=left:1] 		(1) [below of=3]  {};
						\node[vert, label=right:6] 		(6) [right of=3]  {};
					\path
						(5) edge (3)
						(4) edge (3)
						(2) edge (3)
	...
	\begin{figure}[h!]
				...
				\end{tikzpicture}	
			\end{figure}
			\underline{Ans.} $(2,3,5,4), (1,3,5,6)$ respectively.
\end{itemize}
...
\begin{itemize}
	\item[(12c)] {\color{blue}Prove that the Petersen graph is non-planar
			...
			\begin{tikzpicture}[-,>=stealth',shorten >=1pt,auto,node distance=1.5cm, semithick]
 				 \tikzstyle{vert}=[draw, circle, inner sep=2pt,fill=white]
 					 \node[vert, red, label=above:1] 			(A)                    		{};
  					 \node[vert, blue, label=right:6]         (B) [below of=A] {};
  					 \node[vert, blue, label=left:5]         (C) [left of=B] 		{};
  					 \node[vert, blue, label=right:2]         (D) [right of=B] 	{};
					\node[vert, label=above:10]		  (E) [below left=0.5cm and 0.5cm of B] {};
					\node[vert, label=above:7]		  (F) [below right=0.5cm and 0.5cm of B] {};
					\node[vert, red, label=right:8]		  (G) [below=0.5cm and 0cm of F] {}; 					 
  					 \node[vert, red, label=left:9]		  (H) [below= 0.5cm and 0.5cm of E] {};
  					 \node[vert, label=below:4]		  (I)  [below right=2.3cm and 0.5cm of C] {};
  					 \node[vert, label=below:3]		  (J)  [below left=2.3cm and 0.5cm of D] {};
 					 
					 \draw[dashed, thick, blue] (E) -- (F);
					 \draw[dashed, thick, blue] (I) -- (J);
					 \path
							  (A) edge (B)
 					 			(A) edge  (C)
 					 			(A) edge (D)
				...
				\qqaud
			\begin{tikzpicture}[-,>=stealth',shorten >=1pt,auto,node distance=1.5cm, semithick]
 				 \tikzstyle{vert}=[draw, circle, inner sep=1.8pt,fill=white]
				 \node[vert,blue, label=above:5] (5) {};
				 \node[vert,blue, label=above:6] (6) [right of=5] {};
				 \node[vert,blue, label=above:2] (2) [right of=6] {};
				 \node[vert, label=left:4] (4) [below of=5] {};
				 \node[vert, red, label=left:9] (9) [below of=4] {};
				 \node[vert, red, label=left:1] (1) [right of=9] {};
				 \node[vert, red, label=left:8] (8) [right of=1] {};
				 
				 \node[vert, label=left:3] (3) [below of=2] {};
				 \node[vert, label=below:7] (7) [above right =0.5cm and 0.5cm of 9] {};
				 \node[vert, label=below:10] (10) [above left =0.5cm and 0.5cm of 8] {};
		 		\path
					(9) edge (4)
					(4) edge (5)
					(9) edge (6)
		 ...
		 \end{tikzpicture}
			\end{figure}
			As shown in figure, redrawing the Petersen graph in the left of the figure after removing $3-4$ and $10-7$ edges, to the graph in the right of the figure, demostrates how there is a homomorphism between Petersen graph and $K_{3,3}$.\\
			\vfill
			\underline{Ans. (ii)}\\
			\begin{figure}[h!]
			\centering 				
			\begin{tikzpicture}[-,>=stealth',shorten >=1pt,auto,node distance=1.8cm, semithick]
 				 \tikzstyle{vert}=[draw, circle, inner sep=2pt,fill=white]
 					 \node[vert] 		(A)                    		{};
  					 \node[vert]        (B) [below of=A] {};
  					 \node[vert]        (C) [left of=B] 		{};
  					 \node[vert]        (D) [right of=B] 	{};
					 \node[vert]  		(E) [below left=0.5cm and 0.5cm of B] {};
					 \node[vert]		(F) [below right=0.5cm and 0.5cm of B] {};
					 \node[vert]		(G) [below=0.5cm and 0cm of F] {}; 					 
  					 \node[vert]		(H) [below= 0.5cm and 0.5cm of E] {};
					 \node[vert]	  	(I)  [below right=2.3cm and 0.5cm of C] {};
  					 \node[vert]		(J)  [below left=2.3cm and 0.5cm of D] {};
 					 
					 \path
							 (A) edge[red, very thick] (B)
							  (A) edge  (C)
 					 			(A) edge (D)
 					 			(B) edge  (H)
 					 			(B) edge (G)
 					 			(D) edge [red, very thick] (F)
 					 			(F) edge (H)
 					 			(C) edge [red, very thick] (E)
 					 			(E) edge (G)
 					 			(C) edge  (I)
 					 			(H) edge [red, very thick]  (I)
 					 			(D) edge (J)
 					 			(G) edge [red, very thick] (J)
 					 			(F) edge (E)
 					 			(I) edge (J);
				\end{tikzpicture}
				\end{figure}
				Perform edge contractions on edges colored in red. The resulting graph is isomorphic to $K_5$.
